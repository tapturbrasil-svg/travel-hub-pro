...
export const TRIPS: Trip[] = [
  {
    ...
    hotel: {
      ...
      meal: "Café da manhã",
      rooms: [
        { id: "single", name: "Single", capacity: 1, pricePerPerson: 180, description: "Cama solteiro." },
        { id: "double", name: "Duplo", capacity: 2, pricePerPerson: 0, description: "Casal ou duas solteiros." },
        { id: "triple", name: "Triplo", capacity: 3, pricePerPerson: -90, description: "Ideal para amigos." },
        { id: "quad", name: "Quádruplo", capacity: 4, pricePerPerson: -140, description: "Família completa." },
        { id: "suite", name: "Suíte", capacity: 2, pricePerPerson: 220, description: "Suíte com vista mar." },
      ],
    },
  },
  {
    ...
    hotel: {
      ...
      meal: "Café da manhã",
      rooms: [
        { id: "single", name: "Single", capacity: 1, pricePerPerson: 160, description: "Quarto individual." },
        { id: "double", name: "Duplo Vista Mar", capacity: 2, pricePerPerson: 0, description: "Sacada com vista." },
        { id: "triple", name: "Triplo Standard", capacity: 3, pricePerPerson: -70, description: "Acomoda 3 hóspedes." },
        { id: "quad", name: "Quádruplo Família", capacity: 4, pricePerPerson: -120, description: "Famílias com crianças." },
      ],
    },
  },
  {
